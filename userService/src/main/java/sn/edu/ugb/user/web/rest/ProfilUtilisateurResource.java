...
public class ProfilUtilisateurResource {
     ...
     */
    @PostMapping("")
    public ResponseEntity<ProfilUtilisateurDTO> createProfilUtilisateur(@Valid @RequestBody ProfilUtilisateurDTO profilUtilisateurDTO)
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<ProfilUtilisateurDTO> getProfilUtilisateur(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteProfilUtilisateur(@PathVariable("id") Long id) {
